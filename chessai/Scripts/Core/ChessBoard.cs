...
namespace ChessAI.Core
{
    ...
    public partial class ChessBoard : Node2D
    {
        ...
        private const float SQUARE_SIZE = 80f; // pixels per square
        private const float BOARD_OFFSET_X = 40f; // offset from left edge
        private const float BOARD_OFFSET_Y = 40f; // offset from top edge
        #endregion
